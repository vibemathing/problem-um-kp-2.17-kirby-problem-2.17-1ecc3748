...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-2.17-kirby-problem-2.17-1ecc3748-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-2.17"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-2.17-kirby-problem-2.17-1ecc3748-v1",
      "problem_contract_sha256": "4a6ec120a561023fe5c8ce7ae4155ea11782c33a51f608d8d18fda2abc5d6d17",
      "problem_id": "problem:um-kp-2.17-kirby-problem-2.17-1ecc3748",
      "route_id": "route:um-kp-2.17-kirby-problem-2.17-1ecc3748-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-2.17-kirby-problem-2.17-1ecc3748-source-fidelity-01",
      "graph_id": "graph:um-kp-2.17-kirby-problem-2.17-1ecc3748-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-2.17-kirby-problem-2.17-1ecc3748-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-2.17-kirby-problem-2.17-1ecc3748-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose that $c$ is a geodesic current on a hyperbolic surface, and suppose that, on the space of hyperbolic metrics on the surface, $c$ has the same length function as a closed geodesic. Must $c$ be a convex combination of closed curves?"
          },
          "statement_sha256": "599187067add1d1a1bd5f2156dc6394bffebb357850ce371c2c60e611a8ebfb8"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-2.17-kirby-problem-2.17-1ecc3748-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-2.17-kirby-problem-2.17-1ecc3748-root",
      "route_id": "route:um-kp-2.17-kirby-problem-2.17-1ecc3748-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-2.17-537e51b946e8",
        "url": "https://www.unsolvedmath.com/problems/KP-2.17"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
